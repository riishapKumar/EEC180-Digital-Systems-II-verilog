...
//Turns off all LED's in segment display
...
// The negate and active low of 7 seg display cancel out
...
assign HEX0[3] = ( ( ( (SW[3])&(!SW[2])&(SW[0]) ) | ( (!SW[3])&(SW[2])&(SW[1])&(SW[0]) ) | ( (!SW[3])&(SW[2])&(!SW[1])&(!SW[0]) ) | ( (!SW[2])&(!SW[1])&(SW[0]) ) | ( (SW[3])&(SW[2])&(SW[1])&(!SW[0]) ) ); 
assign HEX0[4] = ( (SW[0]) | ( (!SW[3])&(SW[2])&(!SW[1]) ) | ( (SW[3])&(SW[2])&(SW[1]) ) );
assign HEX0[5] = ( ( (SW[3])&(SW[2])&(!SW[1]) ) | ( (!SW[3])&(SW[1])&(SW[0]) ) | ( (!SW[3])&(!SW[2])&(SW[0]) ) | ( (!SW[3])&(!SW[2])&(SW[1]) ) | ( (!SW[2])&(SW[1])&(SW[0]) )  );
assign HEX0[6] = ( ( (!SW[3])&(SW[2])&(SW[1])&(SW[0]) ) | ( (!SW[3])&(!SW[2])&(!SW[1]) ) | ( (SW[3])&(!SW[2])&(SW[1]) ) );
assign HEX0[7] = 1;
